  ...
  return (
    <>
     <div className="container-fluid">
                <div className="row">
                    <div className="col-12 md:px-20 md:my-3 ">
                       
                        <div className={` w-full h-72 flex flex-col justify-center items-center  brightness-50 bg-[url(${API}public/images/${post.image})]  `}>
                            <h1 className="text-white md:text-6xl font-semibold">{post?.heading}</h1>
